...
public class Vehiculo {
    ...
    public int hashCode() {
        int hash = 5;
        hash = 61 * hash + Objects.hashCode(this.bastidor);
        ...
        hash = 61 * hash + (this.disponible ? 1 : 0);
        hash = 61 * hash + (int) (Double.doubleToLongBits(this.tarifa) ^ (Double.doubleToLongBits(this.tarifa) >>> 32));
        return hash;
    }
